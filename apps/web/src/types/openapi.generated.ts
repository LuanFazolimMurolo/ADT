...
export interface paths {
    ...
    "/api/v1/admin/operational-market-data-collectors/start": {
        ...
        put?: never;
        /**
         * Start Operational Market Data Collector
         * @description Persist or replay START without launching physical collection.
         */
        post: operations["start_operational_market_data_collector_api_v1_admin_operational_market_data_collectors_start_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-market-data-collectors/{epoch_id}": {
        ...
        /**
         * Get Operational Market Data Collector
         * @description Return one exact persisted operational collector epoch.
         */
        get: operations["get_operational_market_data_collector_api_v1_admin_operational_market_data_collectors__epoch_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/operational-market-data-collectors/{epoch_id}/commands": {
        ...
        /**
         * List Operational Market Data Collector Commands
         * @description Return bounded immutable collector-command history.
         */
        get: operations["list_operational_market_data_collector_commands_api_v1_admin_operational_market_data_collectors__epoch_id__commands_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/operational-market-data-collectors/{epoch_id}/pause": {
        ...
        put?: never;
        /**
         * Pause Operational Market Data Collector
         * @description Persist PAUSE; the supervisor owns physical convergence.
         */
        post: operations["pause_operational_market_data_collector_api_v1_admin_operational_market_data_collectors__epoch_id__pause_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-market-data-collectors/{epoch_id}/resume": {
        ...
        put?: never;
        /**
         * Resume Operational Market Data Collector
         * @description Persist RESUME without waiting for physical convergence.
         */
        post: operations["resume_operational_market_data_collector_api_v1_admin_operational_market_data_collectors__epoch_id__resume_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-market-data-collectors/{epoch_id}/stop": {
        ...
        put?: never;
        /**
         * Stop Operational Market Data Collector
         * @description Persist STOP without waiting for physical convergence.
         */
        post: operations["stop_operational_market_data_collector_api_v1_admin_operational_market_data_collectors__epoch_id__stop_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-paper-capital-authorizations": {
        ...
        /**
         * List Operational Paper Capital Authorizations
         * @description List one bounded newest-first authorization catalog page.
         */
        get: operations["list_operational_paper_capital_authorizations_api_v1_admin_operational_paper_capital_authorizations_get"];
        put?: never;
        /**
         * Create Operational Paper Capital Authorization
         * @description Create or replay one administrator-scoped paper-capital authorization.
         */
        post: operations["create_operational_paper_capital_authorization_api_v1_admin_operational_paper_capital_authorizations_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-paper-capital-authorizations/{authorization_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get Operational Paper Capital Authorization
         * @description Return one exact paper-capital authorization.
         */
        get: operations["get_operational_paper_capital_authorization_api_v1_admin_operational_paper_capital_authorizations__authorization_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/operational-paper-capital-authorizations/{authorization_id}/revoke": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Revoke Operational Paper Capital Authorization
         * @description Revoke one authorization without route-level lifecycle interpretation.
         */
        post: operations["revoke_operational_paper_capital_authorization_api_v1_admin_operational_paper_capital_authorizations__authorization_id__revoke_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-paper-capital-eras": {
        ...
        put?: never;
        /**
         * Designate Operational Paper Capital Era
         * @description Designate or replay one official simulation era.
         */
        post: operations["designate_operational_paper_capital_era_api_v1_admin_operational_paper_capital_eras_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-paper-session-materializations": {
        ...
        /**
         * List Operational Paper Session Materializations
         * @description List one bounded materialization catalog page.
         */
        get: operations["list_operational_paper_session_materializations_api_v1_admin_operational_paper_session_materializations_get"];
        put?: never;
        /**
         * Materialize Operational Paper Session Authorization
         * @description Materialize or reconcile one authoritative capital authorization.
         */
        post: operations["materialize_operational_paper_session_authorization_api_v1_admin_operational_paper_session_materializations_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-paper-session-materializations/{materialization_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get Operational Paper Session Materialization
         * @description Return one exact operational paper-session materialization.
         */
        get: operations["get_operational_paper_session_materialization_api_v1_admin_operational_paper_session_materializations__materialization_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/operational-paper-session-runs/start": {
        ...
        put?: never;
        /**
         * Start Operational Paper Session Run
         * @description Persist or replay START without launching physical execution.
         */
        post: operations["start_operational_paper_session_run_api_v1_admin_operational_paper_session_runs_start_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-paper-session-runs/{epoch_id}": {
        ...
        /**
         * Get Operational Paper Session Run
         * @description Return one exact persisted run epoch.
         */
        get: operations["get_operational_paper_session_run_api_v1_admin_operational_paper_session_runs__epoch_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/operational-paper-session-runs/{epoch_id}/commands": {
        ...
        /**
         * List Operational Paper Session Run Commands
         * @description Return bounded immutable command history.
         */
        get: operations["list_operational_paper_session_run_commands_api_v1_admin_operational_paper_session_runs__epoch_id__commands_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/operational-paper-session-runs/{epoch_id}/pause": {
        ...
        put?: never;
        /**
         * Pause Operational Paper Session Run
         * @description Persist PAUSE; the supervisor owns physical convergence.
         */
        post: operations["pause_operational_paper_session_run_api_v1_admin_operational_paper_session_runs__epoch_id__pause_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-paper-session-runs/{epoch_id}/resume": {
        ...
        put?: never;
        /**
         * Resume Operational Paper Session Run
         * @description Persist RESUME after application-layer eligibility checks.
         */
        post: operations["resume_operational_paper_session_run_api_v1_admin_operational_paper_session_runs__epoch_id__resume_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-paper-session-runs/{epoch_id}/stop": {
        ...
        put?: never;
        /**
         * Stop Operational Paper Session Run
         * @description Persist STOP without waiting for physical convergence.
         */
        post: operations["stop_operational_paper_session_run_api_v1_admin_operational_paper_session_runs__epoch_id__stop_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/operational-paper-session-settlements": {
        ...
        put?: never;
        /**
         * Settle Operational Paper Session
         * @description Settle one exact terminal session using backend-owned evidence.
         */
        post: operations["settle_operational_paper_session_api_v1_admin_operational_paper_session_settlements_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
         ...
         * @description Bounded immutable collector-command history page.
         */
        OperationalMarketDataCollectorCommandListResponse: {
            /** Items */
            items: components["schemas"]["OperationalMarketDataCollectorCommandResponse"][];
            /** Limit */
            limit: number;
            /** Offset */
            offset: number;
         ...
         * @description Request one lifecycle command using optimistic concurrency.
         */
        OperationalMarketDataCollectorCommandRequest: {
            /** Epoch Checksum */
            epoch_checksum: string;
            /** Expected Record Version */
            expected_record_version: number;
            /** Idempotency Key */
            idempotency_key: string;
         ...
         * @description Immutable administrator command without replay internals.
         */
        OperationalMarketDataCollectorCommandResponse: {
            /**
             * Actor Id
             ...
             */
            command_id: string;
            command_type: components["schemas"]["OperationalMarketDataCollectorCommandType"];
            desired_state: components["schemas"]["OperationalMarketDataCollectorDesiredState"];
            /** Epoch Checksum */
            epoch_checksum: string;
            /**
             * Epoch Id
         ...
         * @enum {string}
         */
        OperationalMarketDataCollectorCommandType: "START" | "PAUSE" | "RESUME" | "STOP";
        /**
         * OperationalMarketDataCollectorDesiredState
         * @enum {string}
         */
        OperationalMarketDataCollectorDesiredState: "RUNNING" | "PAUSED" | "STOPPED";
        /**
         * OperationalMarketDataCollectorEpochResponse
         * @description Auditable epoch without replay secrets or worker identity.
         */
        OperationalMarketDataCollectorEpochResponse: {
            desired_state: components["schemas"]["OperationalMarketDataCollectorDesiredState"];
            /** Epoch Checksum */
             ...
             */
            epoch_id: string;
            failure: components["schemas"]["OperationalMarketDataCollectorFailureResponse"] | null;
            /** Fencing Token */
            fencing_token: number;
            lease: components["schemas"]["OperationalMarketDataCollectorLeaseResponse"] | null;
            observed_state: components["schemas"]["OperationalMarketDataCollectorObservedState"];
            /** Record Version */
            record_version: number;
            specification: components["schemas"]["OperationalMarketDataCollectorSpecificationResponse"];
            /** Specification Checksum */
            specification_checksum: string;
            /**
             * Start Requested At
         ...
         * @enum {string}
         */
        OperationalMarketDataCollectorFailureCode: "COLLECTOR_SPEC_INVALID" | "LOCAL_COLLECTOR_BUSY" | "LOCAL_STATE_INVALID" | "LEASE_LOST" | "DATABASE_UNAVAILABLE" | "INTERNAL_ERROR";
        /**
         * OperationalMarketDataCollectorFailureResponse
         * @description Closed collector failure evidence without arbitrary diagnostics.
         */
        OperationalMarketDataCollectorFailureResponse: {
            code: components["schemas"]["OperationalMarketDataCollectorFailureCode"];
            /**
             * Failed At
             * Format: date-time
             */
        ...
        /**
         * OperationalMarketDataCollectorLeaseResponse
         * @description Lease timing without internal worker identity.
         */
        OperationalMarketDataCollectorLeaseResponse: {
            /**
             * Claimed At
         ...
         * @enum {string}
         */
        OperationalMarketDataCollectorObservedState: "PENDING" | "STARTING" | "RUNNING" | "PAUSED" | "RECOVERING" | "STOPPING" | "STOPPED" | "FAILED";
        /**
         * OperationalMarketDataCollectorScope
         * @enum {string}
         */
        OperationalMarketDataCollectorScope: "BINANCE_SPOT_RAW";
        /**
         * OperationalMarketDataCollectorSpecificationRequest
         * @description Frozen collector target and cadence specification.
         */
        OperationalMarketDataCollectorSpecificationRequest: {
            /** Collector Contract Version */
            collector_contract_version: number;
            /** Interval Seconds */
            interval_seconds: number;
            /** Overlap Candles */
            overlap_candles: number;
            /** Schema Version */
            schema_version: number;
            scope: components["schemas"]["OperationalMarketDataCollectorScope"];
            /** Targets */
            targets: components["schemas"]["OperationalMarketDataCollectorTargetRequest"][];
        };
        /**
         * OperationalMarketDataCollectorSpecificationResponse
         * @description Frozen collector specification exposed for administrator audit.
         */
        OperationalMarketDataCollectorSpecificationResponse: {
            /** Collector Contract Version */
            collector_contract_version: number;
            ...
            scope: components["schemas"]["OperationalMarketDataCollectorScope"];
            /** Targets */
            targets: components["schemas"]["OperationalMarketDataCollectorTargetResponse"][];
        };
        /**
         * OperationalMarketDataCollectorStartRequest
         * @description Create or replay one administrator-scoped collector START.
         */
        OperationalMarketDataCollectorStartRequest: {
            /** Idempotency Key */
            idempotency_key: string;
            specification: components["schemas"]["OperationalMarketDataCollectorSpecificationRequest"];
        };
        /**
         * OperationalMarketDataCollectorTargetRequest
         * @description One exact physical target requested for a collector epoch.
         */
        OperationalMarketDataCollectorTargetRequest: {
            /** Bootstrap Candles */
            bootstrap_candles: number;
            /** Symbol */
            symbol: string;
            /** Timeframe */
            timeframe: string;
        ...
        /**
         * OperationalMarketDataCollectorTargetResponse
         * @description Sanitized frozen collector target.
         */
        OperationalMarketDataCollectorTargetResponse: {
            /** Bootstrap Candles */
            bootstrap_candles: number;
         ...
         * @description Create or replay one administrator-scoped authorization intent.
         */
        OperationalPaperCapitalAuthorizationCreateRequest: {
            /** Idempotency Key */
            idempotency_key: string;
            intent: components["schemas"]["OperationalPaperCapitalAuthorizationIntentRequest"];
        };
        /**
         * OperationalPaperCapitalAuthorizationIntentRequest
         * @description One paper-capital authorization intent.
         */
        OperationalPaperCapitalAuthorizationIntentRequest: {
            /** Authorized Capital */
            authorized_capital: string;
            profile_binding: components["schemas"]["OperationalPaperCapitalAuthorizationProfileBindingRequest"];
            /** Quote Asset */
            quote_asset: string;
            /**
             * Simulation Id
         ...
         * @description Bounded authorization page with the independent filtered total.
         */
        OperationalPaperCapitalAuthorizationListResponse: {
            /** Items */
            items: components["schemas"]["OperationalPaperCapitalAuthorizationResponse"][];
            /** Limit */
            limit: number;
            /** Offset */
            offset: number;
        ...
        /**
         * OperationalPaperCapitalAuthorizationProfileBindingRequest
         * @description Exact approved paper-profile binding supplied by an administrator.
         */
        OperationalPaperCapitalAuthorizationProfileBindingRequest: {
            /** Approved Revision */
        ...
        /**
         * OperationalPaperCapitalAuthorizationProfileBindingResponse
         * @description Exact approved paper-profile authority captured by an authorization.
         */
        OperationalPaperCapitalAuthorizationProfileBindingResponse: {
            /** Approved Revision */
            approved_revision: number;
         ...
         * @description Auditable paper-capital authorization without persistence-only replay internals.
         */
        OperationalPaperCapitalAuthorizationResponse: {
             ...
             */
            created_by: string;
            profile_binding: components["schemas"]["OperationalPaperCapitalAuthorizationProfileBindingResponse"];
            /** Quote Asset */
            quote_asset: string;
            /** Record Version */
            record_version: number;
             ...
             */
            simulation_id: string;
            state: components["schemas"]["OperationalPaperCapitalAuthorizationState"];
        };
        /**
         * OperationalPaperCapitalAuthorizationRevokeRequest
         * @description Revoke one authorization using optimistic concurrency.
         */
        OperationalPaperCapitalAuthorizationRevokeRequest: {
            /** Expected Record Version */
            expected_record_version: number;
         ...
         * @description Designate one simulation as an official paper-capital era.
         */
        OperationalPaperCapitalEraDesignationRequest: {
            /** Idempotency Key */
            idempotency_key: string;
         ...
         * @description Auditable official-era identity without replay internals.
         */
        OperationalPaperCapitalEraResponse: {
            /** Currency */
            currency: string;
            ...
            /** Designation Contract Version */
            designation_contract_version: number;
            /** Era Checksum */
            era_checksum: string;
            /**
             * Era Id
         ...
         * @description Bounded materialization page with the independent filtered total.
         */
        OperationalPaperSessionMaterializationListResponse: {
            /** Items */
            items: components["schemas"]["OperationalPaperSessionMaterializationResponse"][];
            /** Limit */
            limit: number;
            /** Offset */
            offset: number;
         ...
         * @description Exact approved mandate evidence captured by a materialization.
         */
        OperationalPaperSessionMaterializationMandateBindingResponse: {
            /** Approved Revision */
            approved_revision: number;
         ...
         * @description Exact approved paper-profile evidence captured by a materialization.
         */
        OperationalPaperSessionMaterializationProfileBindingResponse: {
            /** Approved Revision */
            approved_revision: number;
         ...
         * @description Auditable materialization provenance without executable config bytes.
         */
        OperationalPaperSessionMaterializationResponse: {
            authorization_binding: components["schemas"]["OperationalPaperSessionMaterializationAuthorizationBindingResponse"];
            /** Config Checksum */
            ...
            materialization_contract_version: number;
            /**
             * Materialization Id
             * Format: uuid
             */
             ...
             */
            simulation_id: string;
            state: components["schemas"]["OperationalPaperSessionMaterializationState"];
        };
        /**
         * OperationalPaperSessionMaterializationState
         * @enum {string}
         */
        OperationalPaperSessionMaterializationState: "PREPARED" | "MATERIALIZED";
         ...
         * @description Bounded immutable command-history page.
         */
        OperationalPaperSessionRunCommandListResponse: {
            /** Items */
            items: components["schemas"]["OperationalPaperSessionRunCommandResponse"][];
            /** Limit */
            limit: number;
            /** Offset */
            offset: number;
        ...
        OperationalPaperSessionRunCommandResponse: {
             ...
             */
            command_id: string;
            command_type: components["schemas"]["OperationalPaperSessionRunCommandType"];
            desired_state: components["schemas"]["OperationalPaperSessionRunDesiredState"];
            /** Epoch Checksum */
            epoch_checksum: string;
            /**
             * Epoch Id
         ...
         * @enum {string}
         */
        OperationalPaperSessionRunCommandType: "START" | "PAUSE" | "RESUME" | "STOP";
        /**
         * OperationalPaperSessionRunDesiredState
         * @enum {string}
         */
        OperationalPaperSessionRunDesiredState: "RUNNING" | "PAUSED" | "STOPPED";
        /**
         * OperationalPaperSessionRunEpochResponse
         * @description Auditable run epoch without replay secrets or worker identity.
         */
        OperationalPaperSessionRunEpochResponse: {
            /** Activation Checksum */
            activation_checksum: string;
             ...
             */
            epoch_id: string;
            failure: components["schemas"]["OperationalPaperSessionRunFailureResponse"] | null;
            /** Fencing Token */
            fencing_token: number;
            lease: components["schemas"]["OperationalPaperSessionRunLeaseResponse"] | null;
            mandate_binding: components["schemas"]["OperationalPaperSessionMaterializationMandateBindingResponse"];
            /** Materialization Checksum */
            materialization_checksum: string;
            /**
             ...
             */
            materialization_id: string;
            observed_state: components["schemas"]["OperationalPaperSessionRunObservedState"];
            profile_binding: components["schemas"]["OperationalPaperSessionMaterializationProfileBindingResponse"];
            /** Record Version */
            record_version: number;
         ...
         * @enum {string}
         */
        OperationalPaperSessionRunFailureCode: "AUTHORITY_LOST" | "ACTIVATION_REVOKED" | "CONFIG_UNAVAILABLE" | "CONFIG_IDENTITY_CONFLICT" | "PLUGIN_UNAVAILABLE" | "RAW_NOT_READY" | "LOCAL_RUNNER_BUSY" | "LOCAL_STATE_INVALID" | "LEASE_LOST" | "INTERNAL_ERROR";
        /**
         * OperationalPaperSessionRunFailureResponse
         * @description Closed run failure evidence without arbitrary diagnostics.
         */
        OperationalPaperSessionRunFailureResponse: {
            code: components["schemas"]["OperationalPaperSessionRunFailureCode"];
            /**
             * Failed At
             * Format: date-time
             */
        ...
        /**
         * OperationalPaperSessionRunLeaseResponse
         * @description Worker lease timing without internal worker identity.
         */
        OperationalPaperSessionRunLeaseResponse: {
            /**
             * Claimed At
         ...
         * @enum {string}
         */
        OperationalPaperSessionRunObservedState: "PENDING" | "STARTING" | "RUNNING" | "PAUSED" | "RECOVERING" | "STOPPING" | "STOPPED" | "FAILED";
        /**
         * OperationalPaperSessionRunStartRequest
         * @description Create or replay one administrator-scoped START intent.
         */
        OperationalPaperSessionRunStartRequest: {
            /** Activation Checksum */
            activation_checksum: string;
         ...
         * @description Request settlement by immutable run identity only.
         */
        OperationalPaperSessionSettlementRequest: {
            /** Epoch Checksum */
            epoch_checksum: string;
         ...
         * @description Immutable settlement identity returned after backend verification.
         */
        OperationalPaperSessionSettlementResponse: {
            /**
             * Settled At
...
export interface operations {
    ...
    start_operational_market_data_collector_api_v1_admin_operational_market_data_collectors_start_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OperationalMarketDataCollectorStartRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalMarketDataCollectorEpochResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    get_operational_market_data_collector_api_v1_admin_operational_market_data_collectors__epoch_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    list_operational_market_data_collector_commands_api_v1_admin_operational_market_data_collectors__epoch_id__commands_get: {
        parameters: {
            query?: {
                limit?: number;
                offset?: number;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalMarketDataCollectorCommandListResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    pause_operational_market_data_collector_api_v1_admin_operational_market_data_collectors__epoch_id__pause_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OperationalMarketDataCollectorCommandRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalMarketDataCollectorCommandResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    resume_operational_market_data_collector_api_v1_admin_operational_market_data_collectors__epoch_id__resume_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    stop_operational_market_data_collector_api_v1_admin_operational_market_data_collectors__epoch_id__stop_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    list_operational_paper_capital_authorizations_api_v1_admin_operational_paper_capital_authorizations_get: {
        parameters: {
            query?: {
                limit?: number;
                offset?: number;
                state?: components["schemas"]["OperationalPaperCapitalAuthorizationState"] | null;
            };
            header?: never;
            path?: never;
            cookie?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalPaperCapitalAuthorizationListResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    create_operational_paper_capital_authorization_api_v1_admin_operational_paper_capital_authorizations_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OperationalPaperCapitalAuthorizationCreateRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    get_operational_paper_capital_authorization_api_v1_admin_operational_paper_capital_authorizations__authorization_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    revoke_operational_paper_capital_authorization_api_v1_admin_operational_paper_capital_authorizations__authorization_id__revoke_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OperationalPaperCapitalAuthorizationRevokeRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    designate_operational_paper_capital_era_api_v1_admin_operational_paper_capital_eras_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OperationalPaperCapitalEraDesignationRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalPaperCapitalEraResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    list_operational_paper_session_materializations_api_v1_admin_operational_paper_session_materializations_get: {
        parameters: {
            query?: {
                limit?: number;
                offset?: number;
                state?: components["schemas"]["OperationalPaperSessionMaterializationState"] | null;
            };
            header?: never;
            path?: never;
            cookie?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalPaperSessionMaterializationListResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    materialize_operational_paper_session_authorization_api_v1_admin_operational_paper_session_materializations_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OperationalPaperSessionMaterializationCreateRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalPaperSessionMaterializationResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    get_operational_paper_session_materialization_api_v1_admin_operational_paper_session_materializations__materialization_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    start_operational_paper_session_run_api_v1_admin_operational_paper_session_runs_start_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OperationalPaperSessionRunStartRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalPaperSessionRunEpochResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    get_operational_paper_session_run_api_v1_admin_operational_paper_session_runs__epoch_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    list_operational_paper_session_run_commands_api_v1_admin_operational_paper_session_runs__epoch_id__commands_get: {
        parameters: {
            query?: {
                limit?: number;
                offset?: number;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalPaperSessionRunCommandListResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    pause_operational_paper_session_run_api_v1_admin_operational_paper_session_runs__epoch_id__pause_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OperationalPaperSessionRunCommandRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalPaperSessionRunCommandResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
    ...
    resume_operational_paper_session_run_api_v1_admin_operational_paper_session_runs__epoch_id__resume_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    stop_operational_paper_session_run_api_v1_admin_operational_paper_session_runs__epoch_id__stop_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    settle_operational_paper_session_api_v1_admin_operational_paper_session_settlements_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["OperationalPaperSessionSettlementRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalPaperSessionSettlementResponse"];
                };
            };
            /** @description Malformed administrative request. */
            400: {
